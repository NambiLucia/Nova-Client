...
>
  ...
  <option value="BUD-01">BUD-01</option>
              ...
              <option value="PROCESSED">PROCESSED</option>
                    ...
                    <button type="submit" className="w-full bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-300">
                        Add Payment
                    </button>
                </form>
            </div>

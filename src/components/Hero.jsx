...
function Hero() {
  ...
  <span className="text-[#3F51B5] italic">NOVA</span> PAYMENT MANAGEMENT SYSTEM
</h1>
            ...
            <div>
            <button className="flex items-center font-Roboto font-semibold text-[#3F51B5] leading-9 ">
  GET STARTED
